...
Basically, download serve.py and put it in a folder. Install flask with 'pip install flask'. Then run 
```loadstring(game:HttpGet("https://github.com/GroceyLot/RobloxPCInterface/raw/Things/interface.lua"))()``` in game to open the ui. In the console of the python it will say something like this:
